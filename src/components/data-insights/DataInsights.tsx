    ...
    return (
        <TooltipProvider>
            <div className="flex flex-col h-full w-full p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
                    ...
                    <Card className="shadow-lg ring-1 ring-blue-200">
                        <CardHeader className="bg-gradient-to-r from-blue-500 to-teal-500 text-white p-4 rounded-t-lg">
                            <CardTitle className="text-lg font-bold flex items-center">
                                <ListFilter className="h-5 w-5 mr-2" />3. Data Preview
                            </CardTitle>
                            <CardDescription className="mt-1 text-blue-100">Preview your filtered dataset</CardDescription>
                        </CardHeader>
                        <CardContent className="bg-white p-6 rounded-b-lg space-y-3">
                ...
                {/* Step 4: Review Summary & Outliers */}
                {selectedSource && !loading && columnsAvailable && (
                    <Card className="shadow-lg ring-1 ring-yellow-200">
                        <CardHeader className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white p-4 rounded-t-lg">
                            <CardTitle className="text-xl font-bold flex items-center">
                                <Activity className="h-5 w-5 mr-2" />4. Review Summary & Outliers
                            </CardTitle>
                            <CardDescription className="mt-1 text-yellow-100">Summary statistics and outlier management</CardDescription>
                        </CardHeader>
                ...
                {localInsightsSummary && !isGeneratingLocalInsights && selectedSource && !loading && !apiError && columnsAvailable && (
                    <Card className="shadow-lg ring-1 ring-indigo-200">
                        <CardHeader className="bg-gradient-to-r from-indigo-600 to-purple-500 text-white p-4 rounded-t-lg">
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-xl font-bold flex items-center">
                            ...
                            <CardDescription className="mt-1 text-indigo-100">Get actionable, AI-powered recommendations in style.</CardDescription>
                        </CardHeader>
